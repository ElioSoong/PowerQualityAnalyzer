    ...
    , m_lineInputLetter("")
{
    ...
    connectDatabase();
    connectFunC();
    p_lineEdit->installEventFilter(this);
}
 ...
 * 	  无
 */
void SoftKeyPad::show(quint32 ID, int Len)
{
    //恢复初始界面
    ...
    case ID_NetWork_Email_ContentHeader:
        ...
        break;
    default:
        QString tempstr = tr("Up to %1 characters").arg(Len);
        p_textEdit->insertPlainText(tempstr);
        break;
    }
...
bool SoftKeyPad::eventFilter(QObject *obj, QEvent *event)
{
    if (obj == p_lineEdit && event->type() == QEvent::FocusOut)
    {
        return true;
    }
    bool res = QWidget::eventFilter(obj, event);

    if (obj == p_lineEdit && event->type() == QEvent::Show)
    {
        p_lineEdit->activateWindow();
        p_lineEdit->setFocus();
    }
    return res;
}
...
void SoftKeyPad::slotButtonEnglishClicked()
{
    ...
    p_buttonEnglish->setStyleSheet("background-color: qlineargradient(x1: 0, y1: 0,"\
                                 ...
                                 "border-radius: 10px; font-family:'Microsoft YaHei';font-size:12px;");
}
...
{
    QString selectStr = p_lineEdit->selectedText();
...
void SoftKeyPad::slotButtonDELPressed()
{
    ...
    if (!selectStr.isEmpty())
    {
        p_lineEdit->activateWindow();
        p_lineEdit->setFocus();
        p_buttonDEL->activateWindow();
        p_buttonDEL->setFocus();
    }
}
...
void SoftKeyPad::slotButtonOKClicked()
{
    ...
    else if (-1 == statusCode)
    {
        ...
        //WinInfoListDialog::instance()->showMsg(statusCode, this);
    }
}
...
#else
    m_currentWidth = MainWindow::instance()->geometry().width();
    m_currentHeight = MainWindow::instance()->geometry().height();
#endif
    setMinimumSize(m_currentWidth, m_currentHeight);
...
void SoftKeyPad::setCenterWidgetLayout()
{
    ...
    p_textEdit->setGeometry((int)(0.0507 * m_currentWidth), (int)(0.03 * m_currentHeight),\
                          (int)(0.733 * m_currentWidth), (int)(0.198 * m_currentHeight));
    ...
    p_buttonBS->setGeometry((int)(0.794 * m_currentWidth), (int)(0.03 * m_currentHeight),\
    ...
    p_buttonDEL->setGeometry((int)(0.8768 * m_currentWidth), (int)(0.03 * m_currentHeight),\
                           (int)(0.0714 *m_currentWidth), (int)(0.0952 * m_currentHeight));
    ...
    p_buttonLeftMove->setGeometry((int)(0.794 * m_currentWidth), (int)(0.1328 * m_currentHeight),\
                                (int)(0.0714 *m_currentWidth), (int)(0.0952 * m_currentHeight));
    p_buttonLeftMove->setIcon(QIcon("resources/icon/buttons/left.png"));
    ...
    p_buttonRightMove->setGeometry((int)(0.8768 * m_currentWidth), (int)(0.1328 * m_currentHeight),\
                                 (int)(0.0714 *m_currentWidth), (int)(0.0952 * m_currentHeight));
    p_buttonRightMove->setIcon(QIcon("resources/icon/buttons/right.png"));
...
void SoftKeyPad::setGroupEndlishLayout()
{
    ...
    p_groupEnglish->button(31)->setGeometry((int)(0.794 * m_currentWidth), (int)(0.44 * m_currentHeight),\
...
void SoftKeyPad::setGroupChineseLayout()
{
    ...
    p_groupChinese->button(31)->setGeometry((int)(0.794 * m_currentWidth), (int)(0.44 * m_currentHeight),\
                                          (int)(0.1532 *m_currentWidth), (int)(0.0952 * m_currentHeight));
...
void SoftKeyPad::setDefaultStyleSheet()
{
    setStyleSheet("QWidget{background-color: rgb(231, 238, 246);}"\
                  "QTextEdit{background-color: rgb(255, 255, 255);font-family:'Microsoft YaHei';font-size:10px;}"\
