...
public:
    ...
    bool addObjectRef(const ObjectRef& objectRef) const;
...
class JSON_LOADER_EXPORT ObjectCreator : public IParser
{
public:
...
protected:
    ...
    void diagnosePropertyWriteError(
        ObjectContext* objectContext, 
        const QString& key, 
...
class VariantArrayValueParser : public ArrayValueParser
{
public:
    VariantArrayValueParser(JsonLoader* loader, int metaType) :
        ArrayValueParser(loader, metaType)
    {

    }

    int parseArrayElementType(int propertyMetaTypeId, const QString& propertyMetaTypeName) const  Q_DECL_OVERRIDE;
    QVariant parseValue(const QVariantList& valueArray) const Q_DECL_OVERRIDE;
};
...
public:
    ...
    virtual int parseArrayElementType(int propertyMetaTypeId, const QString& propertyMetaTypeName) const
    {
        ...
        // Why return m_metaType? 
        // Modified according to the result of UnitTest:tst_Object.registerListParser()
...
public:
    ...
    virtual bool matches(int metaType, const QStringList& tags) const
    {
        ...
        return metaType == QMetaType::Int || 
            metaType == QMetaType::UInt || 
            metaType == EnumNameString || 
